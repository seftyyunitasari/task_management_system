...
RSpec.describe Task, type: :model do
  ...
  describe 'Search function' do
    ...
    let!(:task1) { FactoryBot.create(:task, title: "task1 title", detail: "task1 detail", status: "started") }
    let!(:task2) { FactoryBot.create(:task, title: "task2 title", detail: "task2 detail", status: "not started") }
